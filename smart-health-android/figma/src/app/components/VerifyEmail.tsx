...
export default function VerifyEmail() {
  ...
  const handleResend = async () => {
    ...
    // Giả lập gửi lại email (trong thực tế sẽ gọi API backend)
    ...
    <div className="min-h-screen w-full bg-background flex flex-col">
      <div className="flex-1 flex flex-col p-6 max-w-md mx-auto w-full">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            <h1 className="text-3xl text-[#0B5C9A] mb-2 font-semibold">Xác thực Email</h1>
            <p className="text-muted-foreground px-4">
              Chúng tôi đã gửi mã xác thực 6 chữ số đến địa chỉ email
            </p>
            <p className="text-foreground font-semibold mt-2">bacsituan@benhvien.com</p>
          </motion.div>
        ...
        <div className="text-center text-xs text-muted-foreground pt-6 border-t border-border mt-6">
          ...
          <p className="mt-3">Phần Mềm Y Tế v2.1.0</p>
