...
3. Do not repeat the closed Role/Auth/Register/Approval/RBAC, Shcare Portal settings/workspace-summary/consent, Android family profile/password/2FA/session/workspace-switcher bridges, Supabase/Postgres repository-parity, local storage API, or live performance slices unless new regression evidence appears.
