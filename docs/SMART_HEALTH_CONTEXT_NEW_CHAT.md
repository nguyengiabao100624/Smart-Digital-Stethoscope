...
- Phase 8 remains open: provider/database/secret/public-URL gates and Android runtime/signing are `BLOCKED`; physical HIL is `DEFERRED — chờ phần cứng`; Deep Security remains separately `running/preflight`.
