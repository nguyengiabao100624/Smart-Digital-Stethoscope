...
- Resume only **[“Kế hoạch tích hợp Phase 0–7, bổ sung UI còn thiếu và phát hành Shcare”](SHCARE_LEGACY_UI_FULL_FUNCTION_RELEASE_PLAN.md)** at G3. G0–G2 are complete; G4 has not started. Source checkpoint: `6a28fe2b431ffae5bb9d62d26d712136359f3bd9`.
...
- Proof: Android `117` suites / `838/838`, lint `No issues found`, APK SHA-256 `3807D1274398E52A11D9AB5F7754BE4AF9758C9AE8E03B3DD0C46BCDE369E1A7`; physical ESP `54/54` Unity tests; production firmware SHA-256 `5B61DDAD78613DEB6A1EB4ECFF1C2035C791666838057D5EC71AFC01551EC828`; captive-portal HIL `PASS`; application firmware restored on COM9 and both microphones still active.
